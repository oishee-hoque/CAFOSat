...
log_file_path = "eval_log_main.txt"  # Change this path as needed
...
for state in state_list:
    ...
    config = {
        ...
        'image_folder': os.path.join(base_input_dir, f"{state}"),
        'output_csv': os.path.join(base_output_dir, f"main_misclassified_patches_{state}.csv"),
        'output_csv_classified': os.path.join(base_output_dir, f"main_classified_patches_{state}.csv"),
        'input_size': (224, 224),
        'device': 'cuda',
        'cafo_class_id': 1
    }
